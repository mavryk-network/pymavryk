...
## [3.14.0](https://github.com/mavryk-network/pymavryk/compare/3.13.6...3.14.0) - 2025-01-18
...
- Mavkit binaries updated to v21.2-1
...
## [3.13.6](https://github.com/mavryk-network/pymavryk/compare/3.13.5...3.13.6) (2024-12-13)

### Fixed

- Fixed `mv4` signing suite.
- Boreasnet protocol support

### Changed

- Mavkit binaries updated to v21.0-1

## [3.13.5](https://github.com/mavryk-network/pymavryk/compare/3.13.4...3.13.5) (2024-10-28)

### Added

- Added `mv4` address support.

### Changed

- Mavkit binaries updated to v20.3-1

## [3.13.4](https://github.com/mavryk-network/pymavryk/compare/3.13.3...3.13.4) - 2024-08-19

### Fixed

- Fixed testcontainers version constraint.

## [3.13.3](https://github.com/mavryk-network/pymavryk/compare/3.13.2...3.13.3) - 2024-07-12
...
## [3.13.2](https://github.com/mavryk-network/pymavryk/compare/3.13.1...3.13.2) - 2024-06-27
...
## [3.13.0](https://github.com/mavryk-network/pymavryk/compare/3.12.1...3.13.0) - 2024-06-24
...
- Mavkit binaries updated to v20.1-1

### Fixed

- Fixed Python 3.8 compatibility

## [3.12.1](https://github.com/mavryk-network/pymavryk/compare/3.12.0...3.12.1) - 2024-06-11

### Changed

- Mavkit binaries updated to v20.0-3

## [3.12.0](https://github.com/mavryk-network/pymavryk/compare/3.11.3...3.12.0) - 2024-05-27
...
## [3.11.3](https://github.com/mavryk-network/pymavryk/compare/3.11.2...3.11.3) - 2024-02-23

### Fixed

- Updated cryptographic libraries

## [3.11.2](https://github.com/mavryk-network/pymavryk/compare/3.11.1...3.11.2) - 2024-02-22

### Fixed

- Fixed protocol parameters for sandboxed node

## [3.11.1](https://github.com/mavryk-network/pymavryk/compare/3.11.0...3.11.1) - 2024-02-07

### Added

- Forging/encoding for Smart Rollup State hash

## [3.11.0](https://github.com/mavryk-network/pymavryk/compare/3.10.3...3.11.0) - 2024-02-05
...
## [3.10.3](https://github.com/mavryk-network/pymavryk/compare/3.10.2...3.10.3) - 2023-11-27

### Fixed

- Smart rollup address validation

## [3.10.2](https://github.com/mavryk-network/pymavryk/compare/3.10.1...3.10.2) - 2023-07-05
...
## [3.10.1](https://github.com/mavryk-network/pymavryk/compare/3.10.0...3.10.1) - 2023-07-04

### Added

- Sending/forging new operation kinds: `transfer_ticket`, `smart_rollup_add_messages`, and `smart_rollup_execute_outbox_message`

## [3.10.0](https://github.com/mavryk-network/pymavryk/compare/3.9.0...3.10.0) - 2023-06-13

### Added

- Compatibility with Nairobi protocol

## [3.9.0](https://github.com/mavryk-network/pymavryk/compare/3.8.0...3.9.0) - 2023-03-29
...
- Minimal support for `mv4` and `sr1` addresses
...
## [3.8.0](https://github.com/mavryk-network/pymavryk/compare/3.7.4...3.8.0) - 2023-02-21
...
- Docker images are significantly smaller (231MB -> 107MB for `pymavryk`, 834MB -> 234MB for `michelson-kernel`

## [3.7.4](https://github.com/mavryk-network/pymavryk/compare/3.7.3...3.7.4) - 2023-01-12
...
## [3.7.3](https://github.com/mavryk-network/pymavryk/compare/3.7.2...3.7.3) - 2022-12-20
...
## [3.7.2](https://github.com/mavryk-network/pymavryk/compare/3.7.1...3.7.2) - 2022-11-22

### Added

- `ContractView.run_view` helper that allows to execute on-chain view via special RPC endpoint

## [3.7.1](https://github.com/mavryk-network/pymavryk/compare/3.7.0...3.7.1) - 2022-10-15
...
## [3.7.0](https://github.com/mavryk-network/pymavryk/compare/3.6.1...3.7.0) - 2022-09-17
...
- `ghostnet` is now a default network in pymavryk client (as it is permanent

## [3.6.1](https://github.com/mavryk-network/pymavryk/compare/3.6.0...3.6.1) - 2022-08-04
...
- Fixed `pymavryk sandbox` command crash.
...
## [3.6.0](https://github.com/mavryk-network/pymavryk/compare/3.5.1...3.6.0) - 2022-06-28
...
## [3.5.1](https://github.com/mavryk-network/pymavryk/compare/3.5.0...3.5.1) - 2022-05-18

### Fixed

- Unforging for `pair` with 3 args and annots was working incorrectly (@konchunas

## [3.5.0](https://github.com/mavryk-network/pymavryk/compare/3.4.2...3.5.0) - 2022-04-29
...
- Logging configuration is not overwritten by pymavryk
