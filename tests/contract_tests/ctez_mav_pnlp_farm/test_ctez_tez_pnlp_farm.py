...
class MainnetContractTestCaseCTEZ_MAV_PNLP_FARM(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameter_type_ctez_mav_pnlp_farm(self):
    ...
    def test_entrypoints_ctez_mav_pnlp_farm(self):
    ...
    def test_storage_type_ctez_mav_pnlp_farm(self):
    ...
    def test_storage_encoding_ctez_mav_pnlp_farm(self):
